...
@section('title', 'Reportes y Estadísticas - Botica AMY')
...
">
    ...
    ">
        ...
        <form method="GET" action="{{ route('reportes.ventas') }}" style="margin-bottom: 20px;">
...
">
    ...
    <div style="display: flex; gap: 15px; flex-wrap: wrap;">
        <a href="{{ route('reportes.dashboard') }}" class="btn btn-primary">
            📈 Dashboard Avanzado
        </a>
