...
<div class="actions-card">
    ...
    <div class="actions-buttons">
        <a href="{{ route('reportes.index') }}" class="action-btn btn-primary">
            📊 Ver Reportes
        </a>
        <a href="/ventas/nueva" class="action-btn btn-success">
            💰 Nueva Venta
        </a>
        <a href="{{ route('clientes.index') }}" class="action-btn btn-warning">
            👥 Gestión de Clientes
        </a>
        <a href="{{ route('productos.index') }}" class="action-btn btn-primary">
